...
# An association table is an intermediary table to relate two other tables
# which have a many-to-many relationship.  It has no meaningful fields, it
# is simply the glue to hold two other tables together.
...
def get_model_info(year):
    ...
    for model_name, brand_name, hq in model_info:
        print(model_name, brand_name, hq)
